...
import Data.Ord.Unsafe (unsafeCompare, unsafeCompareBoolean, unsafeCompareInt
  , unsafeCompareNumber, unsafeCompareString, unsafeCompareChar)
...
instance ordBoolean :: Ord Boolean where
  compare = unsafeCompareBoolean

instance ordInt :: Ord Int where
  compare = unsafeCompareInt

instance ordNumber :: Ord Number where
  compare = unsafeCompareNumber

instance ordString :: Ord String where
  compare = unsafeCompareString

instance ordChar :: Ord Char where
  compare = unsafeCompareChar
